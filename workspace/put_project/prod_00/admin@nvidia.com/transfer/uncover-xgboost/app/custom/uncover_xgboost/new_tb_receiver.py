...
class TBNewAnalyticsReceiver(AnalyticsReceiver):
    def __init__(self, job_name, tb_folder="tb_events", events: Optional[List[str]] = None):
    ...
    def initialize(self, fl_ctx: FLContext):
        root_log_dir = os.path.join(self.tb_folder, self.job_name, datetime.today().strftime('%Y-%m-%d'), fl_ctx.get_job_id())
